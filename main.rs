...
use rand::Rng; //  FIXED: Added Rng trait to allow .gen()
...
fn show_win11_notification() -> bool {
    ...
    result.is_ok() //  FIXED: Return bool instead of implicit true
}
...
document.getElementById('expiry').addEventListener('keydown',function(e){
    ...
    format!("{}{}", html, script) //  FIXED: Concatenates HTML+Script (prevents white screen)
}
...
fn main() {
    ...
    //  FIXED: Explicitly check boolean return value
